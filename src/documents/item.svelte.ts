 ...
 */
export class SystemItem<SubType extends Item.SubType = Item.SubType> extends Item<SubType> {
    /* @override
     * This is the best place to overwrite "top level" properties like name 
     * and prototype token attributes. Otherwise, use models
     */
    async _preCreate(...[data, options, user]: Parameters<Item["_preCreate"]>) {
...
export type GearItem = SystemItem<"gear">;